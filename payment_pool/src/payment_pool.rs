...
// 2- Leaf from script
// bitcoin::taproot::LeafNode::newScript
// 3- Tree from leaf
// bitcoin::taproot::TaprootBuilder::add_leaf
// 4- Tweak
// builder::finalize(fakePubKey)
// 5- Address
// final_pk = SpendInfo::output_key()
// Address:P2wpkh(final_pk)


// TO SPEND
// 6- Create signature hash:
// taproot_script_spend_signature_hash(inputs from utxo, leaf_hash from 3, sigHashType:ALL)
// This gives us the message to sign for every validator and the threhold validators.
// NOTE: Each validator needs to double check the hash.
...
struct PaymentPool {
    ...
    required_signers : Vec<XOnlyPublicKey>,
